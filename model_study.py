...
if __name__ == "__main__":
    ...
    shuffle = False
    test_data_ap = CustomisedDataLoader(dataset=test_dataset_ap, batch_size=batch_size, sampler=CustomisedSampler, collate_fn=collate_text2int_fn, shuffle=shuffle)
    test_data_3xr6 = CustomisedDataLoader(dataset=test_dataset_3xr6, batch_size=batch_size, sampler=CustomisedSampler, collate_fn=collate_text2int_fn, shuffle=shuffle)
    test_data_both = CustomisedDataLoader(dataset=test_dataset_both, batch_size=batch_size, sampler=CustomisedSampler, collate_fn=collate_text2int_fn, shuffle=shuffle)
