...
from datasets import Dataset_3xr6, Dataset_ap
...
if __name__ == "__main__":
    ...
    print('SIZES:')
    print(len(train_dataset_200_1))
    print(len(train_dataset_400))
    print(len(train_dataset_1000))
    print(len(train_dataset_200_2))
    print(len(train_dataset))

    # validation_dataset_1 = Dataset_3xr6(validation_folder, reference_file, validation_window_sizes[0], validation_max_windows, hq_value='Q7', max_reads=train_max_reads, validation=True)
    # validation_dataset_2 = Dataset_ap(validation_folder, reference_file, validation_window_sizes[0], validation_max_windows, hq_value='Q7', max_reads=train_max_reads, validation=True)
