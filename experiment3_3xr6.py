...
if __name__ == "__main__":
    ...
    # Load dataset
    train_dataset_200 = Dataset_3xr6(train_folder, reference_file, train_window_sizes[0], train_max_windows, hq_value='Q7', max_reads=train_max_reads)
    train_dataset_400 = Dataset_3xr6(train_folder, reference_file, train_window_sizes[1], train_max_windows, hq_value='Q7', max_reads=train_max_reads)
    ...
    print('TEST')
    print(len(validation_dataset_300))
