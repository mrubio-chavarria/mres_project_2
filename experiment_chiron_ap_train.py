...
import torchaudio
from datasets import Dataset_ap, CombinedDataset
...
if __name__ == "__main__":
    ...
    # Load dataset
    train_dataset_200 = Dataset_ap(train_folder, reference_file, window_sizes[0], max_windows, flowcell='flowcell3', hq_value='Q20')
    train_dataset_400 = Dataset_ap(train_folder, reference_file, window_sizes[1], max_windows, flowcell='flowcell3', hq_value='Q20')
    train_dataset_1000 = Dataset_ap(train_folder, reference_file, window_sizes[2], max_windows, flowcell='flowcell3', hq_value='Q20')
